...
public class ZsdUser {
    ...
    private Integer userSpare;//备用字段 改为 注册类型 0个人 1企业

    private String userSpare2;//备用字段 改为特长
    ...
    public Integer getUserSpare() {
        return userSpare;
    }

    public void setUserSpare(Integer userSpare) {
