...
<c:choose>
	<c:when test="${obj == null}">
		<c:set var="url" value="${ctx }/mamber/insert"></c:set>
		<c:set var="text" value="新增"></c:set>
	</c:when>
	<c:otherwise>
		<c:set var="url" value="${ctx }/mamber/set"></c:set>
...
<body class="contPadding">                   
    ...
    <div class="layui-input-block">
     <input type="text" name="bail" autocomplete="off" placeholder="请输入" class="layui-input"  value="${obj.bail}"/>
    </div>
   </div>
   
   <div class="layui-form-item">
    <label class="layui-form-label">会员充值金额</label>
    <div class="layui-input-block">
     <input type="text" name="mamber" autocomplete="off" placeholder="请输入" class="layui-input"  value="${obj.mamber}"/>
    </div>
   </div>
