...
<body class="contPadding">
	...
	layui.use(['table','form'], function(){
	  ...
	  table.render({
	    elem: '#tableId'
	    ,url:'${ctx}/insurance/toListData'
	    ,cellMinWidth: 80
	    ,page: true
	    ,cols: [[
	      {type:'checkbox'}
	      ,{field:'id', title: 'ID', sort: true}
	      ,{field:'name', title: '保险名称'}
	      ,{field:'money', title: '保险金额'} 
	      ,{field:'detail', title: '详情介绍'}
	...
	function doForm(title,id){
		layer.open({
			  ...
			  maxmin: true,
			  area: ['100%','100%'],
			  content: '${ctx}/insurance/toForm?id='+id,
			  btn: ['立即提交'],
	...
	function doDetails(title,id){
		layer.open({
			  ...
			  maxmin: true,
			  area: ['100%','100%'],
			  content: '${ctx}/insurance/toDetails?id='+id
		 });
	}
