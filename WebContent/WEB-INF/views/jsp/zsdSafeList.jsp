...
<!-- 搜索 -->
	<div class="search">
		<form class="layui-form"> 
			...
			<div class="layui-inline">
				<input class="layui-input" name="phone" id="phone" autocomplete="off" placeholder="请输入投保人电话">
			</div>
	...
	<script type="text/html" id="rbtn">
      ...
      <a class="layui-btn layui-btn-xs" lay-event="edit">邮寄</a>
	...
	layui.use(['table','form'], function(){
	  ...
	  table.render({
	    ...
	    ,cols: [[
	      ...
	      ,{field:'type', title: '保单状态',templet:'#typeConversion'}
	...
	function doDetails(title,id){
		layer.open({
			  ...
			  maxmin: true,
			  area: ['100%','100%'],
			  content: '${ctx}/safe/toDetails?id='+id
		 });
	}
